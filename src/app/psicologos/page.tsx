    ...
    <div className="h-screen">
      ...
      <main className="md:pt-60 md:mx-auto md:max-w-4xl flex flex-col pt-32 px-4">
        ...
        <p className="mt-4 text-muted-foreground text-lg">
          Psiencontre é uma plataforma que conecta pacientes com psicólogos de forma 100% gratuíta.
          Esqueça taxas para sites que ganham valor por sessão. Tenha autonomia para divulgar seu trabalho de graça!
        </p>
